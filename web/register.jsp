...
<div  style="text-align:left;margin:0px auto;margin-top:50px; width:1200px;height:450px;">
    <div style="float:left;width:800px; height:100%; background:#00CC02">
        <img width="800px" src="assets/img/bkg-parallax-1.jpg" style="height: 100%;">
    </div>
    <div style="float:left;width:400px; height:100%; background:#f096091a; font-family:黑体;">
        ...
        <fieldset>
            <form  action="RegisterServlet" method="post" class="form-horizontal" style="margin-top:80px;margin-left:100px;">
                ...
                <br><br>
                确认&nbsp;&nbsp;<input type="text" id="inputPasswords" name="passwords" >
                <br><br>
                用户&nbsp;&nbsp;<input type="text" id="inputEmail" name="email" >
                <br><br>
                <button style="margin-left:60px; " type="submit" class="btn" >注册</button>
                <a href="login.jsp" type="submit" class="btn" style="height: 20px;width: 46px;">登陆</a>&nbsp;&nbsp;
            </form>
        </fieldset>
    </div>
</div>
